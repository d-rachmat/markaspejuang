...
/// </summary>
public class KinectManager : Controller<GameplayApps> 
{
...
//	public bool useOwnThread = false; 
    ...
    #region Custom code
    //Check if user lost from kinect range
    private bool _isUserLostFromKinect;
    /// <summary>
    /// Check if user lost from kinect range
    /// </summary>
    public bool isUserLostFromKinect
    {
        set; get;
    }
    private int _idUserLost;
    public int idUserLost
    {
        set; get;
    }
...
////// 		turnaround mode end
		...
		if(lostUsers.Count > 0)
		{
			foreach(Int64 userId in lostUsers)
			{
				...
				{
                    #region Custom code
                    idUserLost = GetRemovedUserId(userId);
                    isUserLostFromKinect = true;
                    #endregion
...
//			}
    ...
    protected virtual void CalibrateUser(Int64 userId, int bodyIndex)
    {
		if(!alUserIds.Contains(userId))
		{
			if(CheckForCalibrationPose(userId, bodyIndex, playerCalibrationPose))
			{
                ...
                #region Custom Code
                app.model.modelData.allPlayer[uidIndex] = uidIndex;
                #endregion
    ...
    /// <summary>
    /// My Custom Code, get removed user id
    /// </summary>
    /// <param name="userId"></param>
    /// <returns></returns>
    protected virtual int GetRemovedUserId(Int64 userId)
    {
        return Array.IndexOf(aUserIndexIds, userId);
    }
	...
	protected virtual void RemoveUser(Int64 userId)
	{
        ...
        app.model.modelData.allPlayer[uidIndex] = -1;
